        ...
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-3 rounded-xl text-slate-900 placeholder-slate-400 bg-transparent
              focus:outline-none focus:ring-2 focus:ring-sky-400/40 text-sm"
          />
        </div>
        ...
        <div className="relative flex-1 min-w-0 flex items-center">
          ...
          {hasLocation || locationText ? (
            ...
            <button
              ...
              className="absolute right-2 text-slate-400 hover:text-sky-600 disabled:opacity-50 transition-colors cursor-pointer"
            >
              {isLocating
